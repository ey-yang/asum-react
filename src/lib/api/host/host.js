...
// 호스트 등록
export const apply = ({ host_image, host_name, host_phone, business_type, business_license, bank_account, about, contract, personal_information }) =>
    client.post('http://192.168.1.104:3065/api/host/apply', { host_image, host_name, host_phone, business_type, business_license, bank_account, about, contract, personal_information });
